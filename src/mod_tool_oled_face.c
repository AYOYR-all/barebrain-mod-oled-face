...
static const brn_tool_t oled_face_tool = {
    .name = "oled_face",
    .description = "Switch OLED face expression: idle, happy, online, thinking, error, speaking.",
    .input_schema_json =
        "{\"type\":\"object\","
        "\"properties\":{\"emotion\":{\"type\":\"string\",\"enum\":[\"idle\",\"happy\",\"online\",\"thinking\",\"error\",\"speaking\"]}},"
        "\"required\":[\"emotion\"]}",
